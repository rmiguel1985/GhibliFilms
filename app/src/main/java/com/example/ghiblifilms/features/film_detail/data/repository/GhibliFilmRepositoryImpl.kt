...
class GhibliFilmRepositoryImpl(
    ...
    override suspend fun getFilm(filmId: String): Result<FilmModel> =
        ghibliFilmCloudDataSource.getFilm(filmId)

    override suspend fun getTrailer(filmName: String): Result<Trailer> =
        ghibliFilmCloudDataSource.getTrailer(filmName)
}
